...
::: notes
You can also do it the other way around, but I'm not showing that because this is a good way. It sets up the local Git repository for immediate pulling and pushing. Under the hood, we are doing git clone. GitHub, Project, Stage, Commit and Push, Check online Then describe common workflow
:::
...
-   All of the above works, but do you see any issues? ![](figures/bomb.png){.absolute bottom="20%" right="38%" width="250" height="250"}
